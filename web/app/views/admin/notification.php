...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (addNotificationToDB($data)) {
        ...
        header('Location: /app/views/admin/notification.php?success=1');
        exit();
    } else {
        error_log("Failed to create notification in database");
        header('Location: /app/views/admin/notification.php?error=1');
        exit();
    }
}
?>
    ...
    <main class="flex-1 p-10">
        ...
        <div class="bg-white rounded-xl shadow p-10 max-w-2xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="sent_notifications" class="bg-[#a6b98a] text-white px-6 py-2 rounded-lg font-semibold text-base shadow hover:bg-[#7b5434] transition">View Sent Notifications</a>
            </div>
